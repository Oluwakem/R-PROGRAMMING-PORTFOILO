...
Four variables were chosen to explore .I chose one of those four variables as the response variable and the other three as predictors.
...
Two different appropriate regressions predicting the variable indicated in Q10. These regressions uses different predictor(s). 
